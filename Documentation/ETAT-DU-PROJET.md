...
| `vigie_hse_doc_types` | Types de document (tableau de chaînes) — always-merge : les types livrés sont toujours présents, ceux créés par un rédacteur s'y ajoutent. Un type retiré de la liste reste affiché sur les documents qui le portent | `base-documentaire.html` (onglet Documents officiels) |
