...
- [ ] **Liens contextuels** : dans le **Document Unique** et dans le **Registre AT/MP** (colonne « Risque » — un risque « Routier » ouvre la fiche « Routiers », « Chute d'objet » et « Déplacement » n'ont pas encore de pastille), une ligne dont la famille de risque est connue affiche une pastille « fiche » qui ouvre la bonne fiche (essayer aussi avec un compte en lecture seule) ; une famille ajoutée à la main dans les référentiels n'affiche pas de pastille. Dans **Évaluer un risque**, choisir une famille fait apparaître « Lire la fiche de ce risque » sous le champ. Ouvrir une adresse `base-documentaire.html?fiche=nimportequoi` affiche un message clair au lieu d'une page vide.
