...
- [ ] Exports PDF/Excel disponibles sur tous les registres qui en ont l'usage.
  ...
  - **PDF : reste à trancher.** Seuls 5 registres ont un bouton d'impression/PDF (Registre AT/MP, Document Unique, Reporting, Santé & Visites pour les convocations, Accueil au poste). Choix de périmètre à faire avec l'utilisateur.
