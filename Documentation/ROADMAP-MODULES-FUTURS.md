...
- **Complété le 2026-09-21 (réponse Q10 du préventeur)** :
  ...
  - **Types de document créés par le préventeur lui-même** (`vigie_hse_doc_types`, always-merge) : la liste s'édite **dans la page**, accessible à tout compte rédacteur — et non dans Administration, réservée aux administrateurs. Types livrés : politique HSE, procédure, consigne de sécurité, note de service, arrêté, flash sécurité, fiche métier, texte officiel, compte-rendu, autre. Un type utilisé par un document ne peut pas être retiré par mégarde ; un type retiré reste affiché sur les documents qui le portent.
