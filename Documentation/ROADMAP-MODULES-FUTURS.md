...
- **Registre AT/MP relié le 2026-09-23** : la colonne « Risque » porte la même pastille « fiche ». Le registre ayant sa propre liste de 9 risques (issue du fichier source), 7 sont rattachés — 5 par le nom, 2 par une correspondance sans ambiguïté (`EQUIVALENCES` dans `assets/risques-ref.js`). « Chute d'objet » et « Déplacement » restent sans lien en attendant la réponse du préventeur à **Q11**.
